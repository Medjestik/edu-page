      ...
      <div className="container">
        <div className="education__container">
          ...
          <div className="education__info">
            ...
            <p className="education__subtitle">Вы получаете знания и&nbsp;используете единую современную и&nbsp;удобную<span className="education__subtitle_weight_bold"> образовательную платформу. </span>Все лекции задания хранятся в&nbsp;одном месте.</p>
